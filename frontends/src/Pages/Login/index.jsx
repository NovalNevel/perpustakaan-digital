...
const LoginPage = () => {
  ...
  return (
      <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#0c1445] via-[#132e63] to-[#010a1f]">
        <FlickeringGrid
          squareSize={6}
          gridGap={6}
          flickerChance={0.7}
            ...
            <div className="w-full flex flex-col items-center">
              <div className="w-full flex justify-start mb-4">
                <button onClick={handleBackClick} className="hover:opacity-70 transition">
                  <img
                    src="./public/images/img_arrowleft.svg"
                    alt="Kembali"
                    className="w-6 h-6"
                  />
                </button>
